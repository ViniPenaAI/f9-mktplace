...
const products: { id: ProductType; label: string; shortLabel: string; icon: React.ReactNode }[] = [
    { id: "rotulo", label: "Rótulos", shortLabel: "Rótulos", icon: <Tag className="w-8 h-8" /> },
    { id: "banner", label: "Banners", shortLabel: "Banners", icon: <Megaphone className="w-8 h-8" /> },
    { id: "faixa", label: "Faixas", shortLabel: "Faixas", icon: <RectangleHorizontal className="w-8 h-8" /> },
    { id: "adesivo", label: "Adesivo de Recorte", shortLabel: "Adesivo de Recorte", icon: <Sticker className="w-8 h-8" /> },
