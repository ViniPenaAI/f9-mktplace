...
import { Upload, Sparkles, MessageCircle, RefreshCw, Wand2, Image as ImageIcon, FileImage, Square, Circle, RectangleHorizontal, Star, Layers, Package } from "lucide-react";
import { cn } from "@/lib/utils";
import type { ProductFormat, PresentationType } from "@/store/configurator-store";
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <Card>
                    <CardContent className="pt-6">
                        <div
                            className="flex flex-col items-center justify-center min-h-[220px] border-2 border-dashed border-gray-200 rounded-xl bg-gray-50/50 hover:bg-gray-50 transition-colors cursor-pointer"
                        ...
                        >
                            ...
                            {uploadedFile ? (
                                ...
                                <>
                                    ...
                                    <h4 className="text-lg font-bold text-gray-700 mb-2">Arraste seu arquivo aqui ou clique para selecionar</h4>
                                    <p className="text-sm text-gray-500">PDF, PNG, JPG, AI, PSD (máx. 50MB)</p>
                ...
                {/* Ajustes: tamanho, formato, recorte (se adesivo), apresentação — só após ter arte */}
                {uploadedFile && (
                    <Card>
