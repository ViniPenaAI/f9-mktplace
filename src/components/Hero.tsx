...
export function Hero() {
    ...
    const handleComecarAgora = (e: React.MouseEvent<HTMLAnchorElement>) => {
        if (pathname === "/") {
            e.preventDefault();
    ...
    return (
        <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-f9-navy text-white">
            ...
            <div className="container relative z-10 px-4 pt-24 md:pt-20 text-center flex flex-col items-center justify-center">
                <motion.div
                ...
                >
                    ...
                    <div></div>
                    <div></div>
                    <h1 className="text-5xl sm:text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-tight max-w-5xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
                        <Button asChild size="lg" className="w-full sm:w-auto bg-f9-blue/80 border border-white/40 text-white font-bold h-14 px-8 text-lg rounded-full backdrop-blur-md shadow-[0_0_20px_rgba(30,0,255,0.35)] transition-transform hover:scale-105 hover:bg-f9-blue">
                            <a href="/#configurator" onClick={handleComecarAgora} className="inline-flex items-center">
                                Começar Agora
