...
export function Preloader() {
    ...
    return (
        ...
        >
            ...
            <div className="relative w-[660px] h-[660px] md:w-[300px] md:h-[300px] flex items-center justify-center">
                {/* Tamanho único para alinhar centro da máscara ao centro visual da logo */}
                <div className="relative w-[620px] h-[620px] md:w-[660px] md:h-[660px]">
